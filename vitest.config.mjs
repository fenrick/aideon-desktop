  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'app/AideonDesktop/src/aideon/canvas/**',
        'app/AideonDesktop/src/aideon/shell/**',
        'app/AideonDesktop/src/workspaces/metis/**',
        'app/AideonDesktop/src/workspaces/mneme/**',
        'app/AideonDesktop/src/workspaces/praxis/components/chrome/**',
        'app/AideonDesktop/src/workspaces/praxis/components/dashboard/**',
        'app/AideonDesktop/src/workspaces/praxis/components/shell/**',
        'app/AideonDesktop/src/workspaces/praxis/widgets/**',
        'app/AideonDesktop/src/hooks/**',
      ],
    },
  },
});
